...
import { AuthProvider, ThemeProvider, SettingsProvider, useAuth, DeleteConfirmationProvider } from './context/AppContext'
              ...
              <BrowserRouter>
                <Routes>
                  ...
                  <Route path="/" element={
                    ...
                    <Route path="dashboard" element={<PermissionGuard requiredPath="/dashboard"><ErrorBoundary><Dashboard /></ErrorBoundary></PermissionGuard>} />
                    <Route path="inventory" element={<PermissionGuard requiredPath="/inventory"><ErrorBoundary><Inventory /></ErrorBoundary></PermissionGuard>} />
